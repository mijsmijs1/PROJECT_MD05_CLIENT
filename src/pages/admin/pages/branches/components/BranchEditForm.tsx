...
import { Branch, categoryAction } from '@slices/category.slice';
import { Modal, message } from 'antd';
import { api } from '@/services/apis';

export default function BranchEditForm({ dispatch, setDisplayEdit, updateData }: {
    dispatch: any,
    setDisplayEdit: any,
    updateData: Branch
}) {
    async function handleEditBranch(e) {
        ...
        try {
            ...
            let result = await api.branch.update(updateData.id, newCate)
            Modal.success({
                title: "Notication",
                content: "Bạn đã update branch thành công!",
                onOk: () => {
